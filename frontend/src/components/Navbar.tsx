    ...
    <div className='w-full bg-white/30 fixed top-0 shadow backdrop-blur-xl z-50'>
        ...
        {menu && (
            <div className='lg:hidden w-full bg-white px-3 py-3 fixed top-12 shadow'>
                ...
                {isLoggedIn ? <Button onClick={() => navigate('/dashboard')} className='px-3 py-4 bg-transparent text-neutral-800 hover:underline hover:bg-transparent text-base font-semibold w-full'>Dashboard</Button> : <div className='w-full flex flex-col items-start justify-start gap-1'>
                    <Button onClick={() => navigate('/auth')} className='px-3 py-4 bg-transparent text-neutral-800 hover:underline hover:bg-transparent text-base font-semibold w-full'>Log In</Button>
